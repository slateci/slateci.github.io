...
2. Create a `Submit` object for your job as shown below under the sourcecode and snapshot (Please note that you'd need to add in your OSG project name, where it says `<your-project-name>`, to the job.): 
