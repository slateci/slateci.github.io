...
Considering the number of jobs we'll be submitting in this demo, and the number of local processes created by condor to handle that, we recommend increasing the resource limit in the config file as follows:
