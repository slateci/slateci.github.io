...
- [Operating System Requirements](#operating-system-requirements)
  ...
  * [Use iptables for Bridged Network Traffic](#use-iptables-for-bridged-network-traffic)
- [Installing Docker and Kubernetes](#installing-docker-and-kubernetes)
  * [Docker](#docker)
  * [Kubernetes](#kubernetes)
- [SLATE Master Node](#slate-master-node)
  * [Initialize the Kubernetes cluster with Kubeadm](#initialize-the-kubernetes-cluster-with-kubeadm)
  * [KubeConfig](#kubeconfig)
  * [Pod Network](#pod-network)
  * [Load Balancer](#load-balancer)
  * [MetalLB](#metallb)
    + [MetalLB on OpenStack](#metallb-on-openstack)
  * [(optional) Allowing user pods to run on the Master](#-optional--allowing-user-pods-to-run-on-the-master)
- [SLATE Worker Node](#slate-worker-node)
  * [KubeADM Join](#kubeadm-join)
- [Cluster Federation](#cluster-federation)
  * [SLATE CLI](#slate-cli)
  * [Joining the Federation](#joining-the-federation)
  * [Update Cluster Location](#update-cluster-location)
  * [Allow Group Access](#allow-group-access)
- [Troubleshooting](#troubleshooting)
  * ["slate cluster create" command hangs and times out](#-slate-cluster-create--command-hangs-and-times-out)
